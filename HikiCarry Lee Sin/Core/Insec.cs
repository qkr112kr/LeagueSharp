...
namespace HikiCarry_Lee_Sin.Core
{
    class Insec
    {
        ...
        /// <returns></returns>
        public static Vector3 AllyInsec(float distance, Obj_AI_Hero enemy)
        {
            var ally = ObjectManager.Get<Obj_AI_Hero>().Where(x => !x.IsMe && !x.IsDead && x.IsVisible && x.IsAlly).OrderBy(o => o.Distance(ObjectManager.Player.Position)).FirstOrDefault();
        ...
        /// <param name="enemy">insec enemy</param>
        /// <returns></returns>
        public static Vector3 CursorInsec(float distance, Obj_AI_Hero enemy)
        {
        ...
        /// <param name="enemy">insec enemy</param>
        /// <returns></returns>
        public static Vector3 TowerInsec(int distance, Obj_AI_Hero enemy)
        {
        ...
        public static void ClickInsec()
        {
            if (Program.Config.Item("obj.usage").GetValue<bool>())
            {
                if (Program.Config.Item("flash.usage").GetValue<bool>())
                {
                    ...
                    {
                        Obj_AI_Hero selectedTargetx = TargetSelector.GetSelectedTarget();
        ...
        /// <param name="enemy">insec enemy</param>
        /// <returns></returns>
        public static Vector3 InsecPositions(Obj_AI_Hero enemy)
        {
            switch (Program.Config.Item("insec.to").GetValue<StringList>().SelectedIndex)
            {
                case 0:
