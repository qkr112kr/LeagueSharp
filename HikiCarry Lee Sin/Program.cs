...
namespace HikiCarry_Lee_Sin
{
    class Program
    {
        ...
        {
            Plugins.Activator.HikiTiamat((Obj_AI_Hero)unit);
            Plugins.Activator.HikiHydra((Obj_AI_Hero)unit);
            Plugins.Activator.HikiBilgewater((Obj_AI_Hero)unit);
            Plugins.Activator.HikiBlade((Obj_AI_Hero)unit);
            Plugins.Activator.HikiRanduin((Obj_AI_Hero)unit);
            Plugins.Activator.HikiYoumuu((Obj_AI_Hero)unit);
            Plugins.Activator.HikiTitanic((Obj_AI_Hero)unit);
        }
