...
namespace Jhin___The_Virtuoso.Extensions
{
    static class Provider
    {
        ...
        /// Hitchance Array
        /// </summary>
        private static readonly HitChance[] HitchanceArray = { HitChance.Low, HitChance.Medium, HitChance.High, HitChance.VeryHigh, HitChance.Immobile };
        ...
        {
            var aCalculator = ObjectManager.Player.CalcDamage(enemy, (Damage.DamageType)DamageType.Physical, ObjectManager.Player.TotalAttackDamage);
