...
namespace Jhin___The_Virtuoso.Extensions
{
    static class Spells
    {
        ...
        /// <returns></returns>
        public static int GetDamage(this Spell spell, Obj_AI_Hero unit)
        {
        ...
        /// <param name="unit">Target</param>
        /// <returns></returns>
        public static float ComboDamage(this Spell spell1, Spell spell2, Spell spell3, Spell spell4, Obj_AI_Hero unit)
        {
            var combodamage = 0f;
            if (spell1.IsReady())
            {
