...
namespace SSHCommon
{
    public abstract class BaseChamp
    {
        ...
        public Menu Config, combo, ult, harass, laneclear, misc, drawing, evade, pred, activator,protector,jungle,esettings,killsteal;
        ...
        public HitChance HikiChance { get
        {
            return
                SSHCommon.Utility.HitchanceArray[
                    Program.Champion.Config.Item("CRHITCHANCE").GetValue<StringList>().SelectedIndex];
        } }
