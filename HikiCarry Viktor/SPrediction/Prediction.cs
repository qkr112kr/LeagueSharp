...
namespace HikiCarry_Viktor.SPrediction
{
    /// <summary>
    ...
    public static class Prediction
    {
        ...
        public static void Initialize(Menu mainMenu = null)
        {
            ...
            if (mainMenu != null)
            {
                predMenu = new Menu("Prediction Settings", "SPRED");
        ...
        static void Obj_AI_Hero_OnProcessSpellCast(Obj_AI_Base sender, GameObjectProcessSpellCastEventArgs args)
        {
            lock (LastSpells)
            {
                ...
                {
                    if (sender.Spellbook.Spells.Find(p => p.Name == args.SData.Name).Slot == SpellSlot.E && !LastSpells.Exists(p => p.name == args.SData.Name))
                    {
