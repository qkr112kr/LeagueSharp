...
namespace DetuksSharp
{
    ...
    public class DeathWalker
    {
        ...
        {
            menuIn.AddItem(new MenuItem("Combo_Key", "Combo").SetValue(new KeyBind(32, KeyBindType.Press)));
            menuIn.AddItem(new MenuItem("Harass_Key", "Harass").SetValue(new KeyBind('C', KeyBindType.Press)));
            menuIn.AddItem(new MenuItem("LaneClear_Key", "Clear").SetValue(new KeyBind('V', KeyBindType.Press)));
            menuIn.AddItem(new MenuItem("LastHit_Key", "LastHit").SetValue(new KeyBind('X', KeyBindType.Press)));
