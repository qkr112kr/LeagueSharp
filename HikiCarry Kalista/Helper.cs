...
namespace HikiCarry_Kalista
{
    class Helper
    {
        public static bool AsunasUndyBuff(Obj_AI_Hero target)
        {
        ...
        {
            foreach (var support in ObjectManager.Get<Obj_AI_Hero>().Where(x=> x.IsAlly && !x.IsMe && x.Distance(ObjectManager.Player.Position) < Program.R.Range &&
        ...
        public static bool ImmobileDetector(Obj_AI_Hero target)
        {
