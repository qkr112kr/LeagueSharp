...
namespace HikiCarry_Support.Champions
{
    public class Leona
    {
        ...
        private static void Combo()
        {
            ...
            if (Q.IsReady() && SSeries.Config.Item("qCombo").GetValue<bool>())
            {
                foreach (
                   var en in
            ...
            if (E.IsReady() && SSeries.Config.Item("eCombo").GetValue<bool>())
            {
                foreach (
                   var en in
                       HeroManager.Enemies.Where(
            ...
            if (W.IsReady() && SSeries.Config.Item("wCombo").GetValue<bool>())
            {
                foreach (
                   var en in
                       HeroManager.Enemies.Where(
            ...
            if (R.IsReady() && SSeries.Config.Item("rCombo").GetValue<bool>()
