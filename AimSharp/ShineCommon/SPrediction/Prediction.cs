    ...
    public static class Prediction
    {
        ...
        private static void Drawing_OnDraw(EventArgs args)
        {
            if (predMenu != null && predMenu.Item("SPREDDRAWINGS").GetValue<bool>())
            {
                ...
                Drawing.DrawText(Drawing.Width - 200, 40, System.Drawing.Color.Gold, String.Format("Casted Spell Count: {0}", castCount));
                Drawing.DrawText(Drawing.Width - 200, 60, System.Drawing.Color.Gold, String.Format("Hitchance (%): {0}%", (((float)hitCount / (castCount + 1)) * 100).ToString("00.00")));
            }
        }
